...
These are less writeups, more informal notes for myself to remind myself how I solved certain things in CTFs. For this one, it's CSCTF'24. Formal writeups for official events can be found under [Liminova's blog](https://liminova.github.io/) instead.
...
Challenge files: [chall.py](https://nazunacord.net/SXvHabd9xPED.py), [out.py](https://nazunacord.net/LgHdCqWT34yJ.py).
